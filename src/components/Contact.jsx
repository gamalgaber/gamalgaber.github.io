const socialLinks = [
  {
    href: "https://github.com/gamalgaber",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://x.com/pablo17110313",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  return (
    <section className="section" id="contact">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch lg:gap-12">
        ...
        <form
          action="https://getform.io/f/bxojqeja"
        ...
        >
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              placeholder="Hi!"
              required
              className="text-field resize-y min-h-32 max-h-32 reveal-up"
            ></textarea>
          </div>
          <button
            type="submit"
